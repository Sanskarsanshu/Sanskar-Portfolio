...
export const metadata: Metadata = {
  ...
  description:
    "Portfolio of Sanskar — Full Stack Developer & Systems Engineer. 3D interactive web experiences built with Next.js and React Three Fiber.",
  authors: [{ name: "Sanskar" }],
  openGraph: {
    title: "Sanskar — Full Stack Developer",
    description:
      "Portfolio with interactive 3D scene. Next.js, React Three Fiber, Full Stack Engineering.",
    type: "website",
    locale: "en_US",
  },
  twitter: {
